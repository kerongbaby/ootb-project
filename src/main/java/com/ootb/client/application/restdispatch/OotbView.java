...
class OotbView extends ViewWithUiHandlers<OotbUiHandlers> implements OotbPresenter.MyView {
    public interface Binder extends UiBinder<Widget, OotbView> {
    }
...
//    private final DateTimeFormat dateformat = DateTimeFormat.getFormat("yyyy-MM-dd HH:mm:ss");
    ...
    @Inject
    public OotbView(final Binder uiBinder,
